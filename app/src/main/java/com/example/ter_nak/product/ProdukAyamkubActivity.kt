...
import com.example.ter_nak.description.DescriptionAyamkubActivity
...
class ProdukAyamkubActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        descKub.setOnClickListener{
            startActivity(Intent(this, DescriptionAyamkubActivity::class.java))
        }
    }
